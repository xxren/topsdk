...
class CoinActivityCreateRequest
{
	...
	public function setActivityInlineUrl($activityInlineUrl)
	{
		$this->activityInlineUrl = $activityInlineUrl;
		$this->apiParas["activity_inline_url"] = $activityInlineUrl;
	}

	public function getActivityInlineUrl()
	{
